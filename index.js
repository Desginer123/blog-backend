...
mongoose
  .connect('mongodb+srv://admin:dm7yvAgUzJfARrYG@cluster0.m8lgzml.mongodb.net/?retryWrites=true&w=majority')
...
app.get('/postsByTag/:tag', PostController.getPostsByTag);

app.get('/posts', PostController.getAll);
app.get('/comments', CommentController.getAll);

app.get('/popularPosts', PostController.getPopular);
